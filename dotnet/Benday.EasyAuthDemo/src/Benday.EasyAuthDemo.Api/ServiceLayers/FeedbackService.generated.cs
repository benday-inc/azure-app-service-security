...
namespace Benday.EasyAuthDemo.Api.ServiceLayers
{
    public partial class FeedbackService :
        CoreFieldsServiceLayerBase<Benday.EasyAuthDemo.Api.DomainModels.Feedback>,
        IFeedbackService
    {
        private IFeedbackRepository _Repository;
        private FeedbackAdapter _Adapter;
        private IValidatorStrategy<Benday.EasyAuthDemo.Api.DomainModels.Feedback> _ValidatorInstance;
        private ISearchStringParserStrategy _SearchStringParser;
        
        public FeedbackService(
            IFeedbackRepository repository,
            IValidatorStrategy<Benday.EasyAuthDemo.Api.DomainModels.Feedback> validator,
        ...
        public IList<Benday.EasyAuthDemo.Api.DomainModels.Feedback> GetAll(
        ...
        public Benday.EasyAuthDemo.Api.DomainModels.Feedback GetById(int id)
        {
            ...
            {
                var returnValue = new Benday.EasyAuthDemo.Api.DomainModels.Feedback();
        ...
        public void Save(Benday.EasyAuthDemo.Api.DomainModels.Feedback saveThis)
        {
            if (saveThis == null)
            ...
            {
                Benday.EasyAuthDemo.Api.DataAccess.Entities.FeedbackEntity toValue;
                
                if (saveThis.Id == 0)
                {
                    toValue = new Benday.EasyAuthDemo.Api.DataAccess.Entities.FeedbackEntity();
                }
                else
                {
        ...
        public IList<Benday.EasyAuthDemo.Api.DomainModels.Feedback> SimpleSearch(
            string searchValue,
            string sortBy = null,
        ...
        public IList<Benday.EasyAuthDemo.Api.DomainModels.Feedback> Search(
        ...
        public IList<Benday.EasyAuthDemo.Api.DomainModels.Feedback> Search(Search search)
        {
            var returnValues = new List<Benday.EasyAuthDemo.Api.DomainModels.Feedback>();
