...
namespace Benday.EasyAuthDemo.WebUi.Models.Adapters
{
    public partial class FeedbackEditorViewModelAdapter :
        AdapterBase<
        Benday.EasyAuthDemo.Api.DomainModels.Feedback,
        Benday.EasyAuthDemo.WebUi.Models.FeedbackEditorViewModel>
    {
        protected override void PerformAdapt(
            Benday.EasyAuthDemo.Api.DomainModels.Feedback fromValue,
            Benday.EasyAuthDemo.WebUi.Models.FeedbackEditorViewModel toValue)
        {
            if (fromValue == null)
            {
        ...
        protected override AdapterActions BeforeAdapt(
            Benday.EasyAuthDemo.WebUi.Models.FeedbackEditorViewModel fromValue,
            Benday.EasyAuthDemo.Api.DomainModels.Feedback toValue)
        {
            if (fromValue == null)
            {
