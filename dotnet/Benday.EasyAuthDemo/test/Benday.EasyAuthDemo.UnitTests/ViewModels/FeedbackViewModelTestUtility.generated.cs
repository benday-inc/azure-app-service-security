...
namespace Benday.EasyAuthDemo.UnitTests.ViewModels
{
    ...
    {
        public static List<Benday.EasyAuthDemo.WebUi.Models.FeedbackEditorViewModel> CreateEditorViewModels(
            bool createAsUnsaved = true)
        {
            var returnValues = new List<Benday.EasyAuthDemo.WebUi.Models.FeedbackEditorViewModel>();
        ...
        public static Benday.EasyAuthDemo.WebUi.Models.FeedbackEditorViewModel CreateEditorViewModel(
            bool createAsUnsaved = true)
        {
            var fromValue = new Benday.EasyAuthDemo.WebUi.Models.FeedbackEditorViewModel
            {
        ...
        public static void AssertAreEqual(
            ...
            IList<Benday.EasyAuthDemo.WebUi.Models.FeedbackEditorViewModel> actual)
        {
        ...
        public static void AssertAreEqual(
            ...
            Benday.EasyAuthDemo.WebUi.Models.FeedbackEditorViewModel actual)
        {
        ...
        public static void AssertAreEqual(
            IList<Benday.EasyAuthDemo.WebUi.Models.FeedbackEditorViewModel> expected,
        ...
        public static void AssertAreNotEqual(
            Benday.EasyAuthDemo.WebUi.Models.FeedbackEditorViewModel expected,
