...
namespace Benday.EasyAuthDemo.UnitTests.Utilities
{
    ...
    {
        public static List<Benday.EasyAuthDemo.Api.DataAccess.Entities.FeedbackEntity> CreateEntities(
            bool createAsUnsaved = true, bool onlyScalarProperties = true)
        {
            var returnValues = new List<Benday.EasyAuthDemo.Api.DataAccess.Entities.FeedbackEntity>();
        ...
        public static Benday.EasyAuthDemo.Api.DataAccess.Entities.FeedbackEntity CreateEntity(
            bool onlyScalarProperties = false
            )
        {
            var fromValue = new Benday.EasyAuthDemo.Api.DataAccess.Entities.FeedbackEntity
            {
        ...
        public static Benday.EasyAuthDemo.Api.DomainModels.Feedback CreateModel(
            bool createAsUnsaved = true)
        {
            var fromValue = new Benday.EasyAuthDemo.Api.DomainModels.Feedback
            {
                FeedbackType = UnitTestUtility.GetFakeValueForString("FeedbackType"),
                Sentiment = UnitTestUtility.GetFakeValueForString("Sentiment"),
                Subject = UnitTestUtility.GetFakeValueForString("Subject"),
        ...
        public static List<Benday.EasyAuthDemo.Api.DomainModels.Feedback> CreateModels(
            bool createAsUnsaved = true, int numberOfRecords = 10)
        {
            var returnValues = new List<Benday.EasyAuthDemo.Api.DomainModels.Feedback>();
        ...
        public static void ModifyModel(
            Benday.EasyAuthDemo.Api.DomainModels.Feedback fromValue)
        {
            if (fromValue == null)
            {
        ...
        public static void AssertAreEqual(
            IList<Benday.EasyAuthDemo.Api.DomainModels.Feedback> expected,
            IList<Benday.EasyAuthDemo.Api.DataAccess.Entities.FeedbackEntity> actual)
        {
        ...
        public static void AssertAreEqual(
            Benday.EasyAuthDemo.Api.DomainModels.Feedback expected,
            Benday.EasyAuthDemo.Api.DataAccess.Entities.FeedbackEntity actual)
        {
        ...
        public static void AssertAreEqual(
            IList<Benday.EasyAuthDemo.Api.DataAccess.Entities.FeedbackEntity> expected,
            IList<Benday.EasyAuthDemo.Api.DomainModels.Feedback> actual)
        {
            Assert.IsNotNull(expected, "Expected was null.");
            Assert.IsNotNull(actual, "Actual was null.");
            Assert.AreEqual<int>(expected.Count, actual.Count, "Item count should match.");
        ...
        public static void AssertAreEqual(
            Benday.EasyAuthDemo.Api.DataAccess.Entities.FeedbackEntity expected,
            Benday.EasyAuthDemo.Api.DomainModels.Feedback actual)
        {
            Assert.AreEqual<string>(expected.FeedbackType, actual.FeedbackType, "FeedbackType");
            Assert.AreEqual<string>(expected.Sentiment, actual.Sentiment, "Sentiment");
            Assert.AreEqual<string>(expected.Subject, actual.Subject, "Subject");
