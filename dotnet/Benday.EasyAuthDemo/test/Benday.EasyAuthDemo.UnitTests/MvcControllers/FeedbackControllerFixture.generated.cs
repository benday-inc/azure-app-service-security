...
namespace Benday.EasyAuthDemo.UnitTests.MvcControllers
{
    ...
    public class FeedbackControllerFixture
    {
        ...
        private Benday.EasyAuthDemo.WebUi.Controllers.FeedbackController _systemUnderTest;
        
        private Benday.EasyAuthDemo.WebUi.Controllers.FeedbackController SystemUnderTest
        {
            get
            {
                ...
                {
                    _systemUnderTest =
                        new Benday.EasyAuthDemo.WebUi.Controllers.FeedbackController(
