...
namespace Benday.EasyAuthDemo.UnitTests.Adapters
{
    ...
    public class PersonAdapterFixture
    {
        ...
        private static Dictionary<int, Benday.EasyAuthDemo.Api.DomainModels.Person> GetOriginalValuesById(
        ...
        private static Dictionary<int, Benday.EasyAuthDemo.Api.DataAccess.Entities.PersonEntity> GetOriginalValuesById(
