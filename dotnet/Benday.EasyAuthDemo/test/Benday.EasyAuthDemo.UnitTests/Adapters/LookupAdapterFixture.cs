...
namespace Benday.EasyAuthDemo.UnitTests.Adapters
{
    ...
    public class LookupAdapterFixture
    {
        ...
        private static Dictionary<int, Benday.EasyAuthDemo.Api.DomainModels.Lookup> GetOriginalValuesById(
        ...
        private static Dictionary<int, Benday.EasyAuthDemo.Api.DataAccess.Entities.LookupEntity> GetOriginalValuesById(
