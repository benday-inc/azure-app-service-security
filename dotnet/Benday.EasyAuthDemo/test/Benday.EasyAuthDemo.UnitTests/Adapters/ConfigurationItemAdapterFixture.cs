...
namespace Benday.EasyAuthDemo.UnitTests.Adapters
{
    ...
    public class ConfigurationItemAdapterFixture
    {
        ...
        private static Dictionary<int, Benday.EasyAuthDemo.Api.DomainModels.ConfigurationItem> GetOriginalValuesById(
        ...
        private static Dictionary<int, Benday.EasyAuthDemo.Api.DataAccess.Entities.ConfigurationItemEntity> GetOriginalValuesById(
