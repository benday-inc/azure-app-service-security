...
namespace Benday.EasyAuthDemo.UnitTests.Adapters
{
    ...
    public class UserAdapterFixture
    {
        ...
        private static Dictionary<int, Benday.EasyAuthDemo.Api.DomainModels.User> GetOriginalValuesById(
        ...
        private static Dictionary<int, Benday.EasyAuthDemo.Api.DataAccess.Entities.UserEntity> GetOriginalValuesById(
