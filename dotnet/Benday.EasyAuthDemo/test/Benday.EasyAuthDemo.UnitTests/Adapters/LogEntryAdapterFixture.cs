...
namespace Benday.EasyAuthDemo.UnitTests.Adapters
{
    ...
    public class LogEntryAdapterFixture
    {
        ...
        private static Dictionary<int, Benday.EasyAuthDemo.Api.DomainModels.LogEntry> GetOriginalValuesById(
        ...
        private static Dictionary<int, Benday.EasyAuthDemo.Api.DataAccess.Entities.LogEntryEntity> GetOriginalValuesById(
