...
namespace Benday.EasyAuthDemo.UnitTests.Adapters
{
    ...
    public class UserClaimAdapterFixture
    {
        ...
        private static Dictionary<int, Benday.EasyAuthDemo.Api.DomainModels.UserClaim> GetOriginalValuesById(
        ...
        private static Dictionary<int, Benday.EasyAuthDemo.Api.DataAccess.Entities.UserClaimEntity> GetOriginalValuesById(
