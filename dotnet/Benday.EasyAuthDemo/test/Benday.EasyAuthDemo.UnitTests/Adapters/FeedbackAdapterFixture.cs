...
namespace Benday.EasyAuthDemo.UnitTests.Adapters
{
    ...
    public class FeedbackAdapterFixture
    {
        ...
        private static void AssertValuesStillExistAndIdDidNotChange(
            List<Benday.EasyAuthDemo.Api.DomainModels.Feedback> actualValues,
            Dictionary<int, Benday.EasyAuthDemo.Api.DomainModels.Feedback> expectedValuesById)
        {
        ...
        private static Dictionary<int, Benday.EasyAuthDemo.Api.DomainModels.Feedback> GetOriginalValuesById(
            List<Benday.EasyAuthDemo.Api.DomainModels.Feedback> values)
        {
            var originalValuesById =
                new Dictionary<int, Benday.EasyAuthDemo.Api.DomainModels.Feedback>();
        ...
        public void AdaptFeedbackFromModelToEntity()
        {
            ...
            var toValue = new Benday.EasyAuthDemo.Api.DataAccess.Entities.FeedbackEntity();
        ...
        public void AdaptFeedbackFromModelsToEntities_ToEmpty()
        {
            ...
            var toValues = new List<Benday.EasyAuthDemo.Api.DataAccess.Entities.FeedbackEntity>();
        ...
        private static void AssertValuesStillExistAndIdDidNotChange(
            List<Benday.EasyAuthDemo.Api.DataAccess.Entities.FeedbackEntity> actualValues,
            Dictionary<int, Benday.EasyAuthDemo.Api.DataAccess.Entities.FeedbackEntity> expectedValuesById)
        {
            Assert.AreEqual<int>(expectedValuesById.Count, actualValues.Count, "Item count changed.");
        ...
        private static Dictionary<int, Benday.EasyAuthDemo.Api.DataAccess.Entities.FeedbackEntity> GetOriginalValuesById(
            List<Benday.EasyAuthDemo.Api.DataAccess.Entities.FeedbackEntity> values)
        {
            var originalValuesById =
                new Dictionary<int, Benday.EasyAuthDemo.Api.DataAccess.Entities.FeedbackEntity>();
